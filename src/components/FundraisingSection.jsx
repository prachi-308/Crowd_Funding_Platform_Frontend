...
export default function FundraisingSection() {
  ...
  return (
    <section
      ref={ref}
      className="flex items-center justify-center w-full px-6 py-16 md:px-16 lg:px-32" 
    >
      <div className="max-w-[1400px] w-full flex flex-col md:flex-row items-center gap-12 md:gap-16 lg:gap-20 items-center"> 
        ...
        >
          <img
            src={img1}
            alt="Donation Hands"
            className="w-44 h-64 sm:w-56 sm:h-80 md:w-64 md:h-96 lg:w-80 lg:h-[600px] rounded-2xl shadow-lg object-cover"
          />
          <img
            src={img2}
            alt="Fundraising"
            className="w-44 h-64 sm:w-56 sm:h-80 md:w-64 md:h-96 lg:w-80 lg:h-[500px] rounded-2xl shadow-lg object-cover"
          />
        </motion.div>
